...
def generate_trainingset_and_testingset_beta(data, samplesize):
...
if __name__ == '__main__':
    ...
    for idx in range(len(sample_size_all)):
        ...
        for m in range(1, n_exp+1):
            ...
            (training_data,testing_data)=generate_trainingset_and_testingset_beta(dir_data,N_train) # einegns eingefügte Zeile
